...
Renderable content for the Supplementary data-and-code-availability table. All data
accessions were verified to the correct dataset; the analysis code is archived at Zenodo
(concept DOI, see note).
...
- **huARdb DOI reconciliation:** the CD8 atlas used here is **huARdb v2**, described in **Xue et
  ...
  huARdb database paper (Wu et al. 2022, 50(D1):D1244-D1254; doi:10.1093/nar/gkab857) describes the broader resource and is **not**
