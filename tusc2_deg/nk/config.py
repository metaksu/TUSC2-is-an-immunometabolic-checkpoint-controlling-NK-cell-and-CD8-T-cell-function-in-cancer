...
# its own enrichment terms, which is circular. Dropped in degs.run_deseq2/run_wilcoxon
...
# STRESS_EXTRA: TSC22D3 (GILZ, glucocorticoid-induced AP-1/NF-kB inhibitor;
# Ayroldi 2001, Mittelstadt & Ashwell 2001) is a real orphan in both pipelines. CD69/REL/MCL1 do not go here (->
# activation).
...
# No per-gene LFC/padj/baseMean values are hard-coded here because they drift every
