...
data_code_availability.md    # Suppl. Table S1 source (data/code availability)
FIGURE_LEGENDS.md            # panel legends
METHODS.md                   # Methods prose
tusc2_deg/
...
See `METHODS.md` for the full Methods and `FIGURE_LEGENDS.md` for panel legends.
